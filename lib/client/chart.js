    ...
    if ((chart.prevChartWidth !== chartWidth) || (chart.prevChartHeight !== chartHeight)) {
      ...
      if (init) {
        ...
        chart.focus.append('rect')
          .attr('x', chart.xScale(dataRange[0]))
          .attr('y', chart.yScale(utils.scaleMgdl(client.settings.thresholds.bgHigh)))
          .attr('width', chart.xScale(dataRange[1]))
          .attr('height', chart.yScale(utils.scaleMgdl(client.settings.thresholds.bgLow)) - chart.yScale(utils.scaleMgdl(client.settings.thresholds.bgHigh)))
          .attr('fill', 'white')

  ...
  chart.update = _.debounce(function debouncedUpdateChart(init) {
    ...
    if ((chart.prevChartWidth !== chartWidth) || (chart.prevChartHeight !== chartHeight)) {
      ...
      if (init) {
        ...
        window.line_start_x = chart.xScale(dataRange[0]);
        var line_end_x = chart.xScale(dataRange[1]);
        ...
        var tophighline_start_y = (highline_start_y - targettopline_start_y) + highline_start_y;
        var tophighline_end_x = line_end_x;
        var tophighline_end_y = tophighline_start_y;

        // BOTTOM LOW LINE
        var bottomlowline_start_x = line_start_x;
        var bottomlowline_start_y = (lowline_start_y - targetbottomline_start_y) + lowline_start_y;
        var bottomlowline_end_x = line_end_x;
        var bottomlowline_end_y = bottomlowline_start_y;

        // MIDDLE LINE
        var middleline_start_x = line_start_x;
        var middleline_start_y = ((lowline_start_y - highline_start_y)/2) + highline_start_y;
        ...
        var background_width = chart.xScale(dataRange[1]);
        ...
        var darkgreyoverlay_width = 1000;
